...
/usr/pgsql-9.3/bin/psql -d iris_base -h localhost -U postgres -p 5432 -f /home/iris_user/create_functions_and_triggers.sql > error_functions_triggers-v4x.log 2>&1

Then load the dump files and demo data:
/usr/pgsql-9.3/bin/psql -U postgres -d iris_base -f /home/iris_user/dump_db_iris_base_schema_config-v40.sql > error_restore_schema_config-v40.log 2>&1

/usr/pgsql-9.3/bin/psql -U postgres -d iris_base -f /home/iris_user/dump_db_iris_base_dati_di_base-v40.sql > error_restore_dati_di_base-v40.log 2>&1

/usr/pgsql-9.3/bin/psql -U postgres -d iris_base -f /home/iris_user/dump_db_iris_base_realtime-v40.sql > error_restore_realtime-v40.log 2>&1
...
/usr/pgsql-9.3/bin/psql -U postgres -d iris_base -f /home/iris_user/dati_reticolo_idrografico_lombardia.sql > error_restore_cinaturali.log 2>&1
