...
--
-- Name: cinaturali; Type: TABLE; Schema: dati_di_base; Owner: radar; Tablespace: 
--

CREATE TABLE dati_di_base.cinaturali (
    id integer NOT NULL,
...
ALTER TABLE dati_di_base.cinaturali OWNER TO radar;

--
-- Name: TABLE cinaturali; Type: COMMENT; Schema: dati_di_base; Owner: radar
--

COMMENT ON TABLE dati_di_base.cinaturali IS 'reticolo fluviale Lombardia, per prove su MapServer';


--
-- Name: cinaturali_id_seq; Type: SEQUENCE; Schema: dati_di_base; Owner: radar
--

CREATE SEQUENCE dati_di_base.cinaturali_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE dati_di_base.cinaturali_id_seq OWNER TO radar;

--
-- Name: cinaturali_id_seq; Type: SEQUENCE OWNED BY; Schema: dati_di_base; Owner: radar
--

ALTER SEQUENCE dati_di_base.cinaturali_id_seq OWNED BY dati_di_base.cinaturali.id;


--
-- Name: limiti_amministrativi; Type: TABLE; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

CREATE TABLE dati_di_base.limiti_amministrativi (
    gid_padre integer NOT NULL,
    ...
    istat character varying(12),
    popolazione integer
);


ALTER TABLE dati_di_base.limiti_amministrativi OWNER TO postgres;

--
-- Name: TABLE limiti_amministrativi; Type: COMMENT; Schema: dati_di_base; Owner: postgres
--

COMMENT ON TABLE dati_di_base.limiti_amministrativi IS 'Limiti amministrativi per la localizzazione di dati meteo e sismici. Tavola PADRE';


--
-- Name: limiti_amministrativi_prova_gid_padre_seq; Type: SEQUENCE; Schema: dati_di_base; Owner: postgres
--

CREATE SEQUENCE dati_di_base.limiti_amministrativi_prova_gid_padre_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE dati_di_base.limiti_amministrativi_prova_gid_padre_seq OWNER TO postgres;

--
-- Name: limiti_amministrativi_prova_gid_padre_seq; Type: SEQUENCE OWNED BY; Schema: dati_di_base; Owner: postgres
--

ALTER SEQUENCE dati_di_base.limiti_amministrativi_prova_gid_padre_seq OWNED BY dati_di_base.limiti_amministrativi.gid_padre;


--
-- Name: limiti_comuni_2016_simpl500; Type: TABLE; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

CREATE TABLE dati_di_base.limiti_comuni_2016_simpl500 (
    gid integer,
    localita character varying(254),
    comune character varying(254),
    regione character varying(50),
...
ALTER TABLE dati_di_base.limiti_comuni_2016_simpl500 OWNER TO postgres;

--
-- Name: TABLE limiti_comuni_2016_simpl500; Type: COMMENT; Schema: dati_di_base; Owner: postgres
--

COMMENT ON TABLE dati_di_base.limiti_comuni_2016_simpl500 IS 'semplificato a 500 metri: SELECT gid, localita, comune, regione, provincia, sigla_pro, sigla_naz, 
       warning_class, istat, pop_2011
, ST_SimplifyPreserveTopology(the_geom, 500)::geometry(MultiPolygon,32632) AS the_geom
FROM dati_di_base.limiti_comuni_italiani_2016';


--
-- Name: limiti_comuni_italiani_2018; Type: TABLE; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

CREATE TABLE dati_di_base.limiti_comuni_italiani_2018 (
    localita character varying(254),
    comune character varying(254),
    regione character varying(50),
    provincia character varying(50),
...
INHERITS (dati_di_base.limiti_amministrativi);


ALTER TABLE dati_di_base.limiti_comuni_italiani_2018 OWNER TO postgres;

--
-- Name: TABLE limiti_comuni_italiani_2018; Type: COMMENT; Schema: dati_di_base; Owner: postgres
--

COMMENT ON TABLE dati_di_base.limiti_comuni_italiani_2018 IS 'Limiti amministrativi per la localizzazione di dati meteo e sismici. Da shapefile ISTAT 2018';


--
-- Name: limiti_comuni_italiani_2018_child_gid_seq; Type: SEQUENCE; Schema: dati_di_base; Owner: postgres
--

CREATE SEQUENCE dati_di_base.limiti_comuni_italiani_2018_child_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE dati_di_base.limiti_comuni_italiani_2018_child_gid_seq OWNER TO postgres;

--
-- Name: limiti_comuni_italiani_2018_child_gid_seq; Type: SEQUENCE OWNED BY; Schema: dati_di_base; Owner: postgres
--

ALTER SEQUENCE dati_di_base.limiti_comuni_italiani_2018_child_gid_seq OWNED BY dati_di_base.limiti_comuni_italiani_2018.gid;


--
-- Name: limiti_localita_extra_italia; Type: TABLE; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

CREATE TABLE dati_di_base.limiti_localita_extra_italia (
    localita character varying(254),
    comune character varying(254),
    regione character varying(50),
    provincia character varying(50),
...
ALTER TABLE dati_di_base.limiti_localita_extra_italia OWNER TO postgres;

--
-- Name: TABLE limiti_localita_extra_italia; Type: COMMENT; Schema: dati_di_base; Owner: postgres
--

COMMENT ON TABLE dati_di_base.limiti_localita_extra_italia IS 'Limiti amministrativi per la localizzazione di dati meteo e sismici. localita extra-italiane';


--
-- Name: limiti_localita_extra_italia_child_gid_seq; Type: SEQUENCE; Schema: dati_di_base; Owner: postgres
--

CREATE SEQUENCE dati_di_base.limiti_localita_extra_italia_child_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE dati_di_base.limiti_localita_extra_italia_child_gid_seq OWNER TO postgres;

--
-- Name: limiti_localita_extra_italia_child_gid_seq; Type: SEQUENCE OWNED BY; Schema: dati_di_base; Owner: postgres
--

ALTER SEQUENCE dati_di_base.limiti_localita_extra_italia_child_gid_seq OWNED BY dati_di_base.limiti_localita_extra_italia.gid;
...
CREATE TABLE dati_di_base.rete_meteoidrografica (
...
COMMENT ON TABLE dati_di_base.rete_meteoidrografica IS 'rete meteoidrografica. Porre ''meteo_tab=Z'' per DISATTIVARE una stazione!';
...
COMMENT ON COLUMN dati_di_base.rete_meteoidrografica.tipo_staz IS 'alcune lettere poco parlanti: X-sezione fluviale; Y-TERMN';
...
COMMENT ON COLUMN dati_di_base.rete_meteoidrografica.meteo_tab IS 'Classi per tematizzazione su WebGIS:"Meteorologica","Idrometrica","IdrometricaQ" con portata,"Nivometrica","Z" se disattivata';
...
COMMENT ON COLUMN dati_di_base.rete_meteoidrografica.quota_int IS 'E'' la quota_sito ricalcolata come numero intero';
...
CREATE SEQUENCE dati_di_base.rete_meteoidrografica_2_gid_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE dati_di_base.rete_meteoidrografica_2_gid_seq OWNED BY dati_di_base.rete_meteoidrografica.gid;
...
CREATE TABLE dati_di_base.soglie_gamma (
...
COMMENT ON TABLE dati_di_base.soglie_gamma IS 'soglie_gamma';
...
CREATE TABLE dati_di_base.soglie_idrometriche (
    codice_istat_comune character varying(6) NOT NULL,
    progr_punto_com numeric(3,0) NOT NULL,
...
COMMENT ON TABLE dati_di_base.soglie_idrometriche IS 'soglie idrometriche per le stazioni idro, livelli e portata';


--
-- Name: id; Type: DEFAULT; Schema: dati_di_base; Owner: radar
--

ALTER TABLE ONLY dati_di_base.cinaturali ALTER COLUMN id SET DEFAULT nextval('dati_di_base.cinaturali_id_seq'::regclass);


--
-- Name: gid_padre; Type: DEFAULT; Schema: dati_di_base; Owner: postgres
--

ALTER TABLE ONLY dati_di_base.limiti_amministrativi ALTER COLUMN gid_padre SET DEFAULT nextval('dati_di_base.limiti_amministrativi_prova_gid_padre_seq'::regclass);
...
ALTER TABLE ONLY dati_di_base.limiti_comuni_italiani_2018 ALTER COLUMN gid_padre SET DEFAULT nextval('dati_di_base.limiti_amministrativi_prova_gid_padre_seq'::regclass);
...
ALTER TABLE ONLY dati_di_base.limiti_comuni_italiani_2018 ALTER COLUMN gid SET DEFAULT nextval('dati_di_base.limiti_comuni_italiani_2018_child_gid_seq'::regclass);
...
ALTER TABLE ONLY dati_di_base.limiti_localita_extra_italia ALTER COLUMN gid_padre SET DEFAULT nextval('dati_di_base.limiti_amministrativi_prova_gid_padre_seq'::regclass);
...
ALTER TABLE ONLY dati_di_base.limiti_localita_extra_italia ALTER COLUMN gid SET DEFAULT nextval('dati_di_base.limiti_localita_extra_italia_child_gid_seq'::regclass);
...
ALTER TABLE ONLY dati_di_base.rete_meteoidrografica ALTER COLUMN gid SET DEFAULT nextval('dati_di_base.rete_meteoidrografica_2_gid_seq'::regclass);


--
-- Name: cinaturali_id_seq; Type: SEQUENCE SET; Schema: dati_di_base; Owner: radar
--

SELECT pg_catalog.setval('dati_di_base.cinaturali_id_seq', 1, false);


--
-- Data for Name: limiti_amministrativi; Type: TABLE DATA; Schema: dati_di_base; Owner: postgres
--

COPY dati_di_base.limiti_amministrativi (gid_padre, localita, comune, regione, provincia, sigla_pro, sigla_naz, warning_class, the_geom, istat, popolazione) FROM stdin;
\.


--
-- Name: limiti_amministrativi_prova_gid_padre_seq; Type: SEQUENCE SET; Schema: dati_di_base; Owner: postgres
--

SELECT pg_catalog.setval('dati_di_base.limiti_amministrativi_prova_gid_padre_seq', 5970, true);


--
-- Name: limiti_comuni_italiani_2018_child_gid_seq; Type: SEQUENCE SET; Schema: dati_di_base; Owner: postgres
--

SELECT pg_catalog.setval('dati_di_base.limiti_comuni_italiani_2018_child_gid_seq', 5785, true);


--
-- Name: limiti_localita_extra_italia_child_gid_seq; Type: SEQUENCE SET; Schema: dati_di_base; Owner: postgres
--

SELECT pg_catalog.setval('dati_di_base.limiti_localita_extra_italia_child_gid_seq', 185, true);
...
SELECT pg_catalog.setval('dati_di_base.rete_meteoidrografica_2_gid_seq', 1070, true);
...
COPY dati_di_base.soglie_idrometriche (codice_istat_comune, progr_punto_com, id_parametro, codice1, codice2, codice3, data_agg, autore_agg, q_equilibrio, dmv_base, dmv_deroga, zero_idrometrico) FROM stdin;
...
--
-- Name: cinaturali_pkey; Type: CONSTRAINT; Schema: dati_di_base; Owner: radar; Tablespace: 
--

ALTER TABLE ONLY dati_di_base.cinaturali
    ADD CONSTRAINT cinaturali_pkey PRIMARY KEY (id);


--
-- Name: limiti_amministrativi_prova_pkey; Type: CONSTRAINT; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dati_di_base.limiti_amministrativi
    ADD CONSTRAINT limiti_amministrativi_prova_pkey PRIMARY KEY (gid_padre);


--
-- Name: limiti_comuni_italiani_2018_child_pkey; Type: CONSTRAINT; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dati_di_base.limiti_comuni_italiani_2018
    ADD CONSTRAINT limiti_comuni_italiani_2018_child_pkey PRIMARY KEY (gid);


--
-- Name: limiti_localita_extra_italia_child_pkey; Type: CONSTRAINT; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY dati_di_base.limiti_localita_extra_italia
    ADD CONSTRAINT limiti_localita_extra_italia_child_pkey PRIMARY KEY (gid);
...
ALTER TABLE ONLY dati_di_base.soglie_gamma
...
ALTER TABLE ONLY dati_di_base.rete_meteoidrografica
...
ALTER TABLE ONLY dati_di_base.soglie_idrometriche
    ADD CONSTRAINT soglie_idrometriche_pkey PRIMARY KEY (codice_istat_comune, progr_punto_com, id_parametro);


--
-- Name: cinaturali_gist; Type: INDEX; Schema: dati_di_base; Owner: radar; Tablespace: 
--

CREATE INDEX cinaturali_gist ON dati_di_base.cinaturali USING gist (the_geom);


--
-- Name: limamn_2018ch_idx; Type: INDEX; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

CREATE INDEX limamn_2018ch_idx ON dati_di_base.limiti_comuni_italiani_2018 USING gist (the_geom);


--
-- Name: limamn_extraitch_idx; Type: INDEX; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

CREATE INDEX limamn_extraitch_idx ON dati_di_base.limiti_localita_extra_italia USING gist (the_geom);


--
-- Name: limiti_comuni_2016_simpl500_gist; Type: INDEX; Schema: dati_di_base; Owner: postgres; Tablespace: 
--

CREATE INDEX limiti_comuni_2016_simpl500_gist ON dati_di_base.limiti_comuni_2016_simpl500 USING gist (the_geom);
...
CREATE INDEX rete_meteob_idx ON dati_di_base.rete_meteoidrografica USING gist (the_geom);
...
CREATE INDEX rete_meteoidro_istat ON dati_di_base.rete_meteoidrografica USING btree (codice_istat_comune);
...
CREATE INDEX rete_meteoidro_progr ON dati_di_base.rete_meteoidrografica USING btree (progr_punto_com);


--
-- Name: SCHEMA dati_di_base; Type: ACL; Schema: -; Owner: postgres
--
...
--
-- Name: TABLE cinaturali; Type: ACL; Schema: dati_di_base; Owner: radar
--

REVOKE ALL ON TABLE dati_di_base.cinaturali FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.cinaturali FROM radar;
GRANT ALL ON TABLE dati_di_base.cinaturali TO radar;
GRANT SELECT ON TABLE dati_di_base.cinaturali TO webgis_r;


--
-- Name: TABLE limiti_amministrativi; Type: ACL; Schema: dati_di_base; Owner: postgres
--

REVOKE ALL ON TABLE dati_di_base.limiti_amministrativi FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.limiti_amministrativi FROM postgres;
GRANT ALL ON TABLE dati_di_base.limiti_amministrativi TO postgres;
GRANT SELECT ON TABLE dati_di_base.limiti_amministrativi TO webgis_r;
GRANT ALL ON TABLE dati_di_base.limiti_amministrativi TO radar_rw;


--
-- Name: TABLE limiti_comuni_2016_simpl500; Type: ACL; Schema: dati_di_base; Owner: postgres
--

REVOKE ALL ON TABLE dati_di_base.limiti_comuni_2016_simpl500 FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.limiti_comuni_2016_simpl500 FROM postgres;
GRANT ALL ON TABLE dati_di_base.limiti_comuni_2016_simpl500 TO postgres;
GRANT SELECT ON TABLE dati_di_base.limiti_comuni_2016_simpl500 TO webgis_r;
GRANT ALL ON TABLE dati_di_base.limiti_comuni_2016_simpl500 TO radar_rw;


--
-- Name: TABLE limiti_comuni_italiani_2018; Type: ACL; Schema: dati_di_base; Owner: postgres
--

REVOKE ALL ON TABLE dati_di_base.limiti_comuni_italiani_2018 FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.limiti_comuni_italiani_2018 FROM postgres;
GRANT ALL ON TABLE dati_di_base.limiti_comuni_italiani_2018 TO postgres;
GRANT SELECT ON TABLE dati_di_base.limiti_comuni_italiani_2018 TO webgis_r;
GRANT ALL ON TABLE dati_di_base.limiti_comuni_italiani_2018 TO radar_rw;


--
-- Name: TABLE limiti_localita_extra_italia; Type: ACL; Schema: dati_di_base; Owner: postgres
--

REVOKE ALL ON TABLE dati_di_base.limiti_localita_extra_italia FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.limiti_localita_extra_italia FROM postgres;
GRANT ALL ON TABLE dati_di_base.limiti_localita_extra_italia TO postgres;
GRANT SELECT ON TABLE dati_di_base.limiti_localita_extra_italia TO webgis_r;
GRANT ALL ON TABLE dati_di_base.limiti_localita_extra_italia TO radar_rw;


--
-- Name: TABLE rete_meteoidrografica; Type: ACL; Schema: dati_di_base; Owner: postgres
--

REVOKE ALL ON TABLE dati_di_base.rete_meteoidrografica FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.rete_meteoidrografica FROM postgres;
GRANT ALL ON TABLE dati_di_base.rete_meteoidrografica TO postgres;
GRANT SELECT ON TABLE dati_di_base.rete_meteoidrografica TO webgis_r;
GRANT ALL ON TABLE dati_di_base.rete_meteoidrografica TO radar_rw;


--
-- Name: TABLE soglie_gamma; Type: ACL; Schema: dati_di_base; Owner: postgres
--

REVOKE ALL ON TABLE dati_di_base.soglie_gamma FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.soglie_gamma FROM postgres;
GRANT ALL ON TABLE dati_di_base.soglie_gamma TO postgres;
GRANT SELECT ON TABLE dati_di_base.soglie_gamma TO webgis_r;
GRANT ALL ON TABLE dati_di_base.soglie_gamma TO radar_rw;


--
-- Name: TABLE soglie_idrometriche; Type: ACL; Schema: dati_di_base; Owner: postgres
--

REVOKE ALL ON TABLE dati_di_base.soglie_idrometriche FROM PUBLIC;
REVOKE ALL ON TABLE dati_di_base.soglie_idrometriche FROM postgres;
GRANT ALL ON TABLE dati_di_base.soglie_idrometriche TO postgres;
GRANT SELECT ON TABLE dati_di_base.soglie_idrometriche TO webgis_r;
